    ...
    def response(self, flow: http.HTTPFlow) -> None:
        try:
            ...
            event = {
                ...
                "requestTimestampEpochMillis": int(req.timestamp_start * 1000),
                "responseTimestampEpochMillis": int(res.timestamp_end * 1000) if res and res.timestamp_end else None,
                ...
                "responseSize": len(res.raw_content) if res and res.raw_content else (0 if res else None),
    ...
    def error(self, flow: http.HTTPFlow) -> None:
        ...
        try:
            ...
            event = {
                ...
                "requestTimestampEpochMillis": int(req.timestamp_start * 1000) if req and req.timestamp_start else None,
                "responseTimestampEpochMillis": None,
                "protocol": req.http_version if req else None,
