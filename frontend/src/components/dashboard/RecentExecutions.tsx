...
const STATUS_BG: Record<ExecutionStatus, string> = {
  ...
  FAILED_FINALIZATION: 'rgba(248,113,113,0.10)',
        ...
        <table className="w-full text-xs border-collapse">
          ...
          <tbody>
            ...
            {rows.map((row, i) => {
              ...
              const isRun  = ['STARTING', 'RUNNING', 'FINALIZING', 'ABORTING'].includes(row.status)
